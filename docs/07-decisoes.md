...
Data-base: 05/09/2026. As decisões abaixo são propostas para orientar implementação posterior, não confirmações do usuário sobre detalhes não informados.
...
| D06 | Coleta diária no piloto | Alinha hábito diário e scheduler gratuito proposto | Usuário exigir notícias ao longo do dia |
...
| --- | --- | --- |
| Temas preferidos e interesse regional | País, Política, Economia e Sociedade; âmbito nacional | Antes de finalizar interface |
| Variante de português | pt-PT na interface | Antes da revisão de textos |
| Frequência desejada | Uma vez por dia | Antes de configurar scheduler |
...
- Coleta diária perde itens que saem rapidamente do feed: medir janela de cobertura no P0; não prometer arquivo completo; rever periodicidade se necessário.
- Atraso do cron: exibir hora real; aviso após 30 horas sem verificação bem-sucedida.
